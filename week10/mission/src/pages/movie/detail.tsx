...
import { useGetMovieCredit, useGetMovieDetail } from "../../hooks/queries/useGetMovies";
...
const DetailPage = () => {
    ...
    const {
        ...
        queryFn: () => useGetMovieCredit({ movieId: Number(id) }),
    ...
    const {
        ...
        queryFn: () => useGetMovieDetail({ movieId: Number(id) }),
        queryKey: ['movie', 'info'],
        cacheTime: 100000,
    });
